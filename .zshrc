...
alias cb='git checkout `git branch --format="%(align:width=70)%(refname:short)%(end) %(objectname:short) %(align:width=20)%(authorname)%(end) %(subject)" --sort=-committerdate | peco | awk "{print \\$1}"`'
alias ct='git checkout `git tag --format="%(align:width=70)%(refname:short)%(end) %(objectname:short) %(align:width=20)%(authorname)%(end) %(subject)" --sort=-committerdate | peco | awk "{print \\$1}"`'
